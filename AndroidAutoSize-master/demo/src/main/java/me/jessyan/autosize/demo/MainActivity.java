 ...
 * 不懂什么叫基准的话, 请看 {@link AutoSizeConfig @lin kisBaseOnWidth}) 的注释, AndroidAutoSize 默认全局以屏幕宽度为基准进行适配
...
public class MainActivity extends AppCompatActivity {
     ...
     * 跳转前要先在 {@link BaseApplication @link customAdaptForExternal()} 中给外部的三方库 {@link Activity} 自定义适配参数
     *
     * @param view {@link View}
     */
