...
public class UCropActivity extends AppCompatActivity {
    ...
    public void immersive() {
        CropImmersiveManage.immersiveAboveAPI23(this, mStatusBarColor, mToolbarColor, isOpenWhiteStatusBar);
    }
    ...
    private void getCustomOptionsData(@NonNull Intent intent) {
        isOpenWhiteStatusBar =
                intent.getBooleanExtra(UCrop.Options.EXTRA_UCROP_WIDGET_CROP_OPEN_WHITE_STATUSBAR, false);
    ...
    private void processOptions(@NonNull Intent intent) {
        ...
        // custom options
        mOverlayView.setDimmedBorderColor(intent.getIntExtra(UCrop.Options.EXTRA_DIMMED_LAYER_BORDER_COLOR,
        ...
        mGestureCropImageView.setImageToWrapCropBoundsAnimDuration(
                intent.getIntExtra(UCrop.Options.EXTRA_IMAGE_TO_CROP_BOUNDS_ANIM_DURATION,
        ...
        mOverlayView.setShowCropGrid(
                intent.getBooleanExtra(UCrop.Options.EXTRA_SHOW_CROP_GRID, OverlayView.DEFAULT_SHOW_CROP_GRID));
        mOverlayView.setCropGridRowCount(
                intent.getIntExtra(UCrop.Options.EXTRA_CROP_GRID_ROW_COUNT, OverlayView.DEFAULT_CROP_GRID_ROW_COUNT));
        ...
        if (aspectRatioX > 0 && aspectRatioY > 0) {
            ...
            mGestureCropImageView.setTargetAspectRatio(
                    aspectRatioList.get(aspectRationSelectedByDefault).getAspectRatioX() / aspectRatioList.get(
                            aspectRationSelectedByDefault).getAspectRatioY());
        } else {
    ...
    protected void setupViews(@NonNull Intent intent) {
        ...
        mToolbarCropDrawable =
                intent.getIntExtra(UCrop.Options.EXTRA_UCROP_WIDGET_CROP_DRAWABLE, R.drawable.ucrop_ic_done);
        mToolbarTitle = intent.getStringExtra(UCrop.Options.EXTRA_UCROP_TITLE_TEXT_TOOLBAR);
        mToolbarTitle =
                mToolbarTitle != null ? mToolbarTitle : getResources().getString(R.string.ucrop_label_edit_photo);
    ...
    private void setupStatesWrapper() {
        ...
        stateScaleImageView.setImageDrawable(
                new SelectedStateListDrawable(stateScaleImageView.getDrawable(), mActiveControlsWidgetColor));
        stateRotateImageView.setImageDrawable(
                new SelectedStateListDrawable(stateRotateImageView.getDrawable(), mActiveControlsWidgetColor));
        stateAspectRatioImageView.setImageDrawable(
                new SelectedStateListDrawable(stateAspectRatioImageView.getDrawable(), mActiveControlsWidgetColor));
    }
    ...
    private void setupRotateWidget() {
        ...
        ((HorizontalProgressWheelView) findViewById(R.id.rotate_scroll_wheel)).setScrollingListener(
    ...
    private void setupScaleWidget() {
        ...
        ((HorizontalProgressWheelView) findViewById(R.id.scale_scroll_wheel)).setScrollingListener(
                new HorizontalProgressWheelView.ScrollingListener() {
                    @Override
                    public void onScroll(float delta, float totalDistance) {
                        if (delta > 0) {
    ...
    private void setAllowedGestures(int tab) {
        if (isOnTouch()) {
            mGestureCropImageView.setScaleEnabled(isScaleEnabled && mShowBottomControls ? mAllowedGestures[tab] == ALL
                    || mAllowedGestures[tab] == SCALE : isScaleEnabled);
            mGestureCropImageView.setRotateEnabled(isRotateEnabled && mShowBottomControls ? mAllowedGestures[tab] == ALL
                    || mAllowedGestures[tab] == ROTATE : isRotateEnabled);
        }
    }
