...
public class PictureParameterStyle implements Parcelable {
     ...
     * 是否显示Cancel返回
     */
    public boolean isShowTvCancelBack;

    /**
     * 是否隐藏选择文件下
     */
    public boolean isHintFolderMenu;
     ...
     * 标题
     */
    public String pictureTitleText;
     ...
     * 底部完成按钮
     */
    public boolean isPictureBottomConfirm;
     ...
     * 是否底部显示预览
     */
    public boolean isCompletePreview;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte(this.isShowTvCancelBack ? (byte) 1 : (byte) 0);
        dest.writeByte(this.isHintFolderMenu ? (byte) 1 : (byte) 0);
        ...
        dest.writeString(this.pictureTitleText);
        ...
        dest.writeByte(this.isPictureBottomConfirm ? (byte) 1 : (byte) 0);
        ...
        dest.writeByte(this.isCompletePreview ? (byte) 1 : (byte) 0);
    ...
    protected PictureParameterStyle(Parcel in) {
        ...
        this.isShowTvCancelBack = in.readByte() != 0;
        this.isHintFolderMenu = in.readByte() != 0;
        ...
        this.pictureTitleText = in.readString();
        ...
        this.isPictureBottomConfirm = in.readByte() != 0;
        ...
        this.isCompletePreview = in.readByte() != 0;
